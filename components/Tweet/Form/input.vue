   ...
   <div>
      <div class="flex items-center flex-shrink-0 p-4 pb-0">
         <div class="flex 2-12 items-top">
            <img :src="props.user?.profileImage" :alt="props.user.name" class="inline-block w-10 h-10 rounded-full">
         </div>
         ...
         <div class="w-full p-2">
            ...
            class="w-full h-10 text-lg text-gray-900 
             ...
             dark:text-white focus:ring-0 scroll"
      ...
      <div class="p-4 pl-16">
         ...
         <img :src="inputImageUrl" v-if="inputImageUrl" alt="User Image" 
      ...
      <div class="flex p-2 pl-14">
         <div class="flex w-full text-white">
            <div @click="handelImageClick" class="p-2 text-blue-400 rounded-full hover:bg-blue-50 dark:hover:bg-dim-800 cursor-pointer">
